...
namespace szaman
{
	...
	static std::unordered_map<std::string, std::pair<uint32_t, uint8_t>> opcodes = {
		...
		{"ld bc,(n)", {0b11101101010010110000000000000000, 254}},
		{"ld de,(n)", {0b11101101010110110000000000000000, 254}},
		{"ld sp,(n)", {0b11101101011110110000000000000000, 254}},
		...
		{"adc a,(iy+n)", {0b111111011000111000000000, 0}},
		...
		{"sbc a,(iy+n)", {0b111111011001111000000000, 0}},
		...
		{"and (iy+n)", {0b111111011010011000000000, 0}},
		...
		{"or (iy+n)", {0b111111011011011000000000, 0}},
		...
		{"xor (iy+n)", {0b111111010111010100000000, 0}},
		...
		{"cp (iy+n)", {0b111111011011111000000000, 0}},
