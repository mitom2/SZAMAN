...
std::unordered_map<std::string, std::pair<uint32_t, uint8_t>> opcodes = {
		...
		{ "srl a", { 0b1100111100111111 , 255 } },
		{ "srl b", { 0b1100111100111000 , 255 } },
		{ "srl c", { 0b1100111100111001 , 255 } },
		{ "srl d", { 0b1100111100111010 , 255 } },
		{ "srl e", { 0b1100111100111011 , 255 } },
		{ "srl h", { 0b1100111100111100 , 255 } },
		{ "srl l", { 0b1100111100111101 , 255 } },
